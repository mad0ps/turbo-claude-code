...
`CLAUDE_CODE_SUBAGENT_MODEL=haiku` is set globally. Override with `model:` param when needed.
...
|-------|------|---------------|
| **Haiku** (default) | Explore, search, grep, docs, simple lookup, episodic-memory, claude-code-guide | 1x |
